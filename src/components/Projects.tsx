              ...
              <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 overflow-hidden border border-gray-100 group-hover:border-purple-200">
                ...
                <div className="p-8">
                  ...
                  <div className="flex space-x-4">
                    <button className={`group/btn flex items-center space-x-2 bg-gradient-to-r ${project.gradient} text-white px-6 py-3 rounded-xl font-semibold hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl`}>
                      <Github size={18} className="group-hover/btn:rotate-12 transition-transform" />
                      <span>View Code</span>
                    </button>
                    <button className="group/btn flex items-center space-x-2 border-2 border-gray-300 text-gray-700 px-6 py-3 rounded-xl font-semibold hover:border-purple-500 hover:text-purple-600 transition-all duration-300">
